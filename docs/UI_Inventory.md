...
| **Game** | **InseongDispatchBoard** | `AppView/Inseong/InseongDispatchBoard` | Modeless | `z-[35]` | 2단계 고밀도 인성콜 표 배차판 | `gameState === 'PLAYING'` & Stage 2 |
| **Game** | **InseongSetupScreen** | `AppView/Inseong/InseongSetupScreen` | Modal | `z-[40]` | 2단계 현위치/노선 설정 다이얼로그 | `gameState === 'SET_DESTINATION'` & Stage 2 |
